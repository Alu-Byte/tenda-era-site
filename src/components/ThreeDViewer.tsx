...
export default function ThreeDViewer({ src, alt, onClose }: Props) {
  ...
  return (
    ...
    >
      <button
        className="absolute top-4 right-4 text-white hover:text-[#a03e14] transition-colors z-10"
        onClick={onClose}
      >
        <X size={32} />
      </button>
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ textAlign: "center" }}>
              <div style={{ color: "#a03e14", fontSize: 34, fontFamily: "Georgia, serif", fontWeight: 700 }}>Tenda Era</div>
