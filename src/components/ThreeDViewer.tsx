...
export default function ThreeDViewer({ src, alt, onClose }: Props) {
  ...
  return (
    ...
    >
      <button
        className="absolute top-4 right-4 text-white hover:text-[#e11d3c] transition-colors z-10"
        onClick={onClose}
      >
        <X size={32} />
      </button>
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ textAlign: "center" }}>
              <div style={{ color: "#e11d3c", fontSize: 34, fontFamily: "Georgia, serif", fontWeight: 700 }}>Tenda Era</div>
