...
export default function Footer() {
  ...
  return (
    <footer className="bg-neutral-950 text-white relative overflow-hidden">
      {/* Soft accent glow */}
      <div className="absolute -top-40 right-1/4 w-96 h-96 rounded-full bg-[#0d5c63]/10 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 relative">
        ...
        <div className="lg:col-span-1">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-display text-xl font-bold tracking-tight">Tenda <span className="text-[#0d5c63]">Era</span></span>
          </div>
          ...
          <div className="flex gap-2">
            <a href="https://www.facebook.com/profile.php?id=61585040403719" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
              className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#0d5c63] hover:border-[#0d5c63] transition-all touch-manipulation">
            ...
            {[
              ...
              <li key={l.href}>
                <Link href={l.href} className="inline-flex items-center gap-1.5 hover:text-white transition-colors group no-underline">
                  <span className="w-0 group-hover:w-3 h-px bg-[#0d5c63] transition-all" />
                  {l.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-white/60">
            <li className="flex gap-3">
              <MapPin size={16} className="text-[#0d5c63] mt-0.5 shrink-0" />
            ...
            <li className="flex gap-3">
              <Phone size={16} className="text-[#0d5c63] mt-0.5 shrink-0" />
            ...
            <li className="flex gap-3">
              <Mail size={16} className="text-[#0d5c63] mt-0.5 shrink-0" />
            ...
            <li className="flex gap-3">
              <Clock size={16} className="text-[#0d5c63] mt-0.5 shrink-0" />
              <span className="flex flex-col gap-0.5 leading-relaxed">
