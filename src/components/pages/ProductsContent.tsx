        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-end">
            <div className="lg:col-span-6">
              <p className="text-[11px] font-bold uppercase tracking-[0.24em] text-[#a03e14] mb-3">
                — {p.label}
              </p>
          ...
          <div className="mt-10 flex flex-wrap gap-2">
            {categories.map((cat) => (
              <a
                key={cat.id}
                href={`#${cat.id}`}
                className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-[#e3ddd1] rounded-full text-sm font-semibold text-[#1c1917] hover:border-[#a03e14] hover:text-[#a03e14] transition-colors no-underline"
              >
                      ...
                      <div key={sub.id} id={sub.id} className="scroll-mt-24">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8 pb-6 border-b border-[#e3ddd1]">
                          <div className="lg:col-span-4 flex items-start gap-4">
                            <span className="text-[13px] font-mono font-bold text-[#a03e14] tabular-nums mt-1">
                            ...
                            <div>
                              ...
                              {sub.modelUrl && (
                                <button
                                  ...
                                  className="mt-3 inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#1c1917] text-white text-xs font-bold uppercase tracking-wider rounded-full hover:bg-[#a03e14] transition-colors"
                                >
